...
function prompt_zshgod_rectangular_sshonly_username() {
	...
	[[ -n $SSH_CONNECTION ]] && prompt_zshgod_rectangular_username $user_bg_color $user_fg_color $root_bg_color $root_fg_color
}
