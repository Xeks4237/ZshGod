...
prompt_zshgod_setup() {
    ...
    local source $ZSHGOD_HOME/lib/functions_rectangular.zsh
    local source $ZSHGOD_HOME/lib/functions_right-to-left_arrowed.zsh
    local source $ZSHGOD_HOME/lib/functions_left-to-right_arrowed.zsh
